...
RSpec.describe 'new viewing party' do
    before :each do
        @user_1 = User.create(name: 'Test1', email: 'test3@yahoo.com')
        @user_2 = User.create(name: 'Test2', email: 'test4@yahoo.com')
    ...
    describe 'successful submissions' do
      before :each do
          @user_1 = User.create(name: 'Test1', email: 'test4@yahoo.com')
          @user_2 = User.create(name: 'Test2', email: 'test5@yahoo.com')
          @movie = MovieFacade.movie(235)
          visit(user_movie_path(@user_1, 235))
          click_button("Create Viewing Party for Stand by Me")
      end
