...
RSpec.describe 'Viewing Party Show Page' do
    before :each do
        @user_1 = User.create(name: 'Bob', email: 'bob@yahoo.com', password: "user1", password_confirmation: "user1")
        @user_2 = User.create(name: 'Ron', email: 'ron@yahoo.com', password: "user1", password_confirmation: "user1")
        @user_3 = User.create(name: 'Sam', email: 'sam@yahoo.com', password: "user1", password_confirmation: "user1")
